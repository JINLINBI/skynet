...
--
-- Host: 127.0.0.1    Database: gameserver_db
-- ------------------------------------------------------
-- Server version	5.5.5-10.6.21-MariaDB-ubu2004-log
...
CREATE TABLE `t_role_data` (
  ...
  `base` blob DEFAULT NULL,
  `item` blob DEFAULT NULL,
  `shop` blob DEFAULT NULL,
  `social` blob DEFAULT NULL,
  PRIMARY KEY (`uid`),
  UNIQUE KEY `id` (`id`)
...
--
-- Table structure for table `t_role_mail`
--
...
-- Dump completed on 2025-05-18 12:33:35
